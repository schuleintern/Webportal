...
class extStundenplanAdminAcl extends AbstractPage {
	
	public static function getSiteDisplayName() {
		return '<i class="fas fa-user-shield"></i> Stundenplan - Benutzerrechte';
	}
	...
	public function execute() {
        ...
        $form = [
            ...
            "desc" => "Welcher Benutzer darf seinen Stundenplan sehen (lesen)? Und alle anderen sehen (schreiben)?",
            "acl" => [
                "schueler" => [
                    "read" => 1,
                    "write" => 1,
