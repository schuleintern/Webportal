...
class extPodcastAdminAcl extends AbstractPage {
	
	public static function getSiteDisplayName() {
		return '<i class="fas fa-microphone-alt"></i> Podcast - Benutzerrechte';
	}
	...
	public function execute() {
        ...
        $form = [
            "title" => "Podcast hören",
            "desc" => "Welcher Benutzer darf die Podcast sehen und hören?",
            "acl" => [
                "schueler" => [
                    "read" => 1,
                    "write" => 0,
