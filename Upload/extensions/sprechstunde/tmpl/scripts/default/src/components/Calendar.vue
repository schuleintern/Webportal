            ...
            <span v-if="day.slots">
              <span v-bind:key="s" v-for="(slot, s) in day.slots" >
                ...
                <div v-if="slot.dateSet != true" class="si-box">
                  ...
                  <User v-if="slot.user_id != userSelf.id" size="icon" v-bind:data="slot.user"></User>
                  <div v-if="slot.date" class="si-box si-box-green">
                    <h4><i class="far fa-calendar-check margin-r-s"></i> Termin</h4>
                    <User size="icon" v-bind:data="slot.date.user"></User>
                    <div v-if="slot.date.medium" class="padding-s text-small">
                      <span v-if="slot.date.medium == 'live'"><i class="fa fa-handshake"></i> Live</span>
                      <span v-if="slot.date.medium == 'phone'"><i class="fa fa-phone"></i> Telefon</span>
                      <span v-if="slot.date.medium == 'viko'"><i class="fa fa-video"></i> Videokonferenz</span>
                    </div>
                    <div v-if="slot.date.info" class="padding-t-m" style="white-space: normal;">
                  ...
                  <div v-else class="text-right padding-t-s">
                    <button v-if="isFuture(day.day) && slot.user_id != userSelf.id" class="si-btn"
                              v-on:click.stop="openForm(day.day, slot)"> <i class="fa fa-plus"></i> Buchen</button>
