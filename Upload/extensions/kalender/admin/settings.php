...
class extKalenderAdminSettings extends AbstractPage {
	
	public static function getSiteDisplayName() {
		return '<i class="fa fas fa-plug"></i> Kalender - Einstellungen';
	}
    ...
    public static function getSettingsDescription() {
        ...
        */
        ...
        $settings =  [
            ...
            [
                'name' => "extKalender-ics",
                'typ' => 'BOOLEAN',
                'title' => "ICS Feed aktivieren",
                'desc' => ""
            ]
