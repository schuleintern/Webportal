...
class extUserAdminAcl extends AbstractPage {
	
	public static function getSiteDisplayName() {
		return '<i class="fa fa-user"></i> Profil - Benutzerrechte';
	}
	...
	public function execute() {
        ...
        $form = [
            ...
            "desc" => "Welcher Benutzer darf seine Daten bearbeiten (schreiben) und lesen?",
            "acl" => [
                "schueler" => [
                    "read" => 1,
                    "write" => 0,
