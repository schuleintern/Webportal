        ...
        <div class="si-userselect-modal-box" >
          <div class="si-userselect-modal-content">
            ...
            <div class="list">
              ...
              <div class="padding-t-m padding-r-m flex-row" v-if="users.length">
              ...
              <div class="si-form">
                <ul>
                  <li :class="{'text-red': required == true  }">
                    <label>Suche</label>
                    <div class="flex-row">
                      <input class="flex-4" type="text" v-model="searchString" v-on:keyup="handlerChange" />
                      <button class="margin-l-s flex-1 si-btn si-btn-light" v-on:click="handlerChangeAll">Alle</button>
                    </div>
                  </li>
                  <li>
                    <label>Filter</label>
