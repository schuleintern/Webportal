...
class extBoardAdminAcl extends AbstractPage {
	
	public static function getSiteDisplayName() {
		return '<i class="fas fa-user-shield"></i> Boards - Benutzerrechte';
	}
	...
	public function execute() {
        ...
        $form = [
            "title" => "Boards managen",
            "desc" => "Welcher Benutzer darf Boards lesen oder Neue erstellen (schreiben)?",
            "acl" => [
                "schueler" => [
                    "read" => 1,
                    "write" => 0,
