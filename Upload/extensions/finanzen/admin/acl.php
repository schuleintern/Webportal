...
class extFinanzenAdminAcl extends AbstractPage {
	
	public static function getSiteDisplayName() {
		return '<i class="fas fa-user-shield"></i> Finanzen - Benutzerrechte';
	}
	...
	public function execute() {
        ...
        $form = [
            "title" => "Finanzen mangen",
            "desc" => "Welcher Benutzer darf seine Finanzen lesen oder neue Anträge stellen (schreiben)?",
            "acl" => [
                "schueler" => [
                    "read" => 1,
                    "write" => 0,
