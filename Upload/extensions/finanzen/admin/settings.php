...
class extFinanzenAdminSettings extends AbstractPage {
	...
	public static function getSiteDisplayName() {
		return '<i class="fa fas fa-plug"></i> Inbox - Einstellungen';
	}
    ...
    public static function getSettingsDescription() {
        ...
        $settings =  [
            ...
            [
                'name' => "extFinanzen-antrag-order-text-after",
                'typ' => 'TEXT',
                'title' => "Rechnung - Text",
                'desc' => ""
            ],
            [
                'name' => "extFinanzen-antrag-order-number-prefix",
                'typ' => 'TEXT',
                'title' => "Rechnung - Nummer Prefix",
                'desc' => "Default: rn-si"
            ],
            [
                'name' => "extFinanzen-antrag-order-number",
                'typ' => 'NUMBER',
                'title' => "Letzte Rechnungnummer",
                'desc' => "Nicht Ändern!"
            ],
