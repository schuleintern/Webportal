...
class extPausenAdminAcl extends AbstractPage {
	
	public static function getSiteDisplayName() {
		return '<i class="fas fa-user-shield"></i> Pausen - Benutzerrechte';
	}
	...
	public function execute() {
        ...
        $form = [
            "title" => "Aufsichten mangen",
            "desc" => "Welcher Benutzer darf dei Aufsichten lesen oder Neue erstellen (schreiben)?",
            "acl" => [
                "schueler" => [
                    "read" => 1,
                    "write" => 0,
