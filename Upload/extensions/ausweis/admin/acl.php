...
class extAusweisAdminAcl extends AbstractPage {
	
	public static function getSiteDisplayName() {
		return '<i class="fa fa-address-card"></i> Ausweis - Benutzerrechte';
	}
	...
	public function execute() {
        ...
        $form = [
            ...
            "desc" => "Welcher Benutzer darf Ausweise beantragen (schreiben) und öffnen (lesen)?",
            "acl" => [
                "schueler" => [
                    "read" => 1,
                    "write" => 1,
