<template>
  <div>
    ...
    <ItemComponent v-if="page === 'item'" :acl="acl" :ausweis="ausweis" :antrag="list"></ItemComponent>
    <FormComponent v-if="page === 'form'" :acl="acl"  :apiURL="apiURL" :users="users"></FormComponent>
...
export default {
  ...
  components: {
    ...
    ItemComponent, FormComponent
  },
  data() {
    return {
      userID: window.globals.userID,
      users: window.globals.users,
  ...
  methods: {
    ...
    loadAusweis() {
      ...
      this.loading = true;
      var that = this;
      axios.get(this.apiURL + '/getAusweis', {
        headers: {
    ...
    loadAntrag() {
      ...
      this.loading = true;
      var that = this;
      axios.get(this.apiURL + '/getAntrag', {
        headers: {
          'auth-app': window.globals.apiKey,
          'auth-session': sessionID
        }
