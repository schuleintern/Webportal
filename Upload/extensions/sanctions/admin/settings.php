...
class extSanctionsAdminSettings extends AbstractPage {
	
	public static function getSiteDisplayName() {
		return '<i class="fa fas fa-plug"></i> Sanktionen - Admin Einstellungen';
	}
    ...
    public static function getSettingsDescription() {
        ...
        $settings =  [
            [
                'name' => "extSanctions-count-anzahl",
                'typ' => 'NUMBER',
                'title' => "Wie viele Sanktionen?",
                'desc' => "(default:3)"
            ],
            [
                'name' => "extSanctions-rules-text",
                'typ' => 'TEXT',
                'title' => "Regeln",
                'desc' => ""
            ]
