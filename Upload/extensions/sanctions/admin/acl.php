...
class extSanctionsAdminAcl extends AbstractPage {
	
	public static function getSiteDisplayName() {
		return '<i class="fas fa-user-shield"></i> Sanktionen - Benutzerrechte';
	}
	...
	public function execute() {
        ...
        $form = [
            ...
            "desc" => "Welcher Benutzer darf Sanktionen sehen (Lesen) oder neue Stellen (Schreiben)?",
            "acl" => [
                "schueler" => [
                    "read" => 1,
                    "write" => 1,
