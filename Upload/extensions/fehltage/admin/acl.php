...
class extFehltageAdminAcl extends AbstractPage {
	
	public static function getSiteDisplayName() {
		return '<i class="fas fa-user-shield"></i> Fehltage - Benutzerrechte';
	}
	...
	public function execute() {
        ...
        $form = [
            ...
            "desc" => "Welche Benutzergruppe darf die Fehltage sehen?",
            "acl" => [
                "schueler" => [
                    "read" => 1,
                    "write" => 0,
