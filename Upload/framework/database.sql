...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 06. Dez 2020 um 15:02
...
ALTER TABLE `absenzen_absenzen`
    ...
    ADD KEY `absenzDatum` (`absenzDatum`),
    ADD KEY `absenzSchuelerAsvID` (`absenzSchuelerAsvID`);
...
ALTER TABLE `absenzen_attestpflicht`
    ...
    ADD KEY `attestpflichtStart` (`attestpflichtStart`,`attestpflichtEnde`),
...
ALTER TABLE `absenzen_krankmeldungen`
    ...
    ADD KEY `krankmeldungAbsenzID` (`krankmeldungAbsenzID`),
    ADD KEY `krankmeldungDate` (`krankmeldungDate`),
    ADD KEY `krankmeldungElternID` (`krankmeldungElternID`),
    ADD KEY `krankmeldungSchuelerASVID` (`krankmeldungSchuelerASVID`);
...
ALTER TABLE `absenzen_sanizimmer`
    ...
    ADD KEY `sanizimmerSchuelerAsvID` (`sanizimmerSchuelerAsvID`);
...
ALTER TABLE `acl`
    ...
    ADD KEY `moduleClass` (`moduleClass`),
    ADD KEY `moduleClassParent` (`moduleClassParent`);
...
ALTER TABLE `aufeinenblick_settings`
    ...
    ADD KEY `aufeinenblickUserID` (`aufeinenblickUserID`);
...
ALTER TABLE `ausleihe_ausleihe`
    ...
    ADD KEY `ausleiheObjektID` (`ausleiheObjektID`);
...
ALTER TABLE `ausweise`
    ...
    ADD KEY `ausweisArt` (`ausweisArt`),
    ADD KEY `ausweisBezahlt` (`ausweisBezahlt`),
    ADD KEY `ausweisErsteller` (`ausweisErsteller`),
    ADD KEY `ausweisStatus` (`ausweisStatus`);
...
ALTER TABLE `bad_mail`
    ...
    ADD KEY `badMailDone` (`badMailDone`);
...
ALTER TABLE `beurlaubung_antrag`
    ADD PRIMARY KEY (`antragID`) USING BTREE,
    ADD KEY `antragAbsenzID` (`antragAbsenzID`),
    ADD KEY `antragSchuelerAsvID` (`antragSchuelerAsvID`),
    ADD KEY `antragUserID` (`antragUserID`);

--
-- Indizes für die Tabelle `cache`
--
ALTER TABLE `cache`
    ADD PRIMARY KEY (`cacheKey`) USING BTREE;
...
--
-- Indizes für die Tabelle `kms`
--
ALTER TABLE `kms`
    ADD PRIMARY KEY (`kmsID`) USING BTREE;
...
ALTER TABLE `schueler_quarantaene`
    ...
    ADD KEY `quarantaeneSchuelerAsvID` (`quarantaeneSchuelerAsvID`),
...
ALTER TABLE `users`
    ADD PRIMARY KEY (`userID`) USING BTREE,
    ADD KEY `userName` (`userName`(1024));
...
--
-- AUTO_INCREMENT für Tabelle `kms`
--
ALTER TABLE `kms`
    MODIFY `kmsID` int(11) NOT NULL AUTO_INCREMENT;
