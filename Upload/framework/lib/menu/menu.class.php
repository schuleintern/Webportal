...
class menu extends AbstractMenu
{
    ...
    private function adminMenu()
    {
        ...
        if (DB::getSession()->isAdmin()) $modulAdminHTML .= $this->getMenuItem('administration', 'Administration', 'fa fa-cogs');
        //if(DB::getSession()->isAdmin()) $modulAdminHTML .= $this->getMenuItem('AdminInfo', 'Info / Statistik', 'fa fa-check');
