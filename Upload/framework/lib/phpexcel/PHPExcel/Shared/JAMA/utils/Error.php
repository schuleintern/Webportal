...
$error['FR'][POLYMORPHIC_ARGUMENT_EXCEPTION] = "ModÃ¨le inadmissible d'argument pour la fonction polymorphe.".
$error['DE'][POLYMORPHIC_ARGUMENT_EXCEPTION] = "UnzulÃ¤ssiges Argumentmuster fÃ¼r polymorphe Funktion.";
...
$error['DE'][ARGUMENT_TYPE_EXCEPTION] = "UnzulÃ¤ssige Argumentart.";
...
$error['DE'][ARGUMENT_BOUNDS_EXCEPTION] = "UnzulÃ¤ssige Argumentstrecke.";

define('MATRIX_DIMENSION_EXCEPTION', -4);
$error['EN'][MATRIX_DIMENSION_EXCEPTION] = "Matrix dimensions are not equal.";
$error['FR'][MATRIX_DIMENSION_EXCEPTION] = "Les dimensions de Matrix ne sont pas Ã©gales.";
$error['DE'][MATRIX_DIMENSION_EXCEPTION] = "MatrixmaÃŸe sind nicht gleich.";

define('PRECISION_LOSS_EXCEPTION', -5);
$error['EN'][PRECISION_LOSS_EXCEPTION] = "Significant precision loss detected.";
$error['FR'][PRECISION_LOSS_EXCEPTION] = "Perte significative de prÃ©cision dÃ©tectÃ©e.";
$error['DE'][PRECISION_LOSS_EXCEPTION] = "Bedeutender PrÃ¤zision Verlust ermittelte.";
...
$error['FR'][MATRIX_SPD_EXCEPTION] = "Perte significative de prÃ©cision dÃ©tectÃ©e.";
$error['DE'][MATRIX_SPD_EXCEPTION] = "Bedeutender PrÃ¤zision Verlust ermittelte.";
