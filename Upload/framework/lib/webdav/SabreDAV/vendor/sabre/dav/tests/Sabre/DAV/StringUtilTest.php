...
class StringUtilTest extends \PHPUnit_Framework_TestCase {
    ...
    function dataset() {
        ...
        return [
            ...
            ['FÃ–Ã–BAR', 'FÃ–Ã–',    'i;octet', 'contains', true],
            ['FÃ–Ã–BAR', 'fÃ¶Ã¶',    'i;octet', 'contains', false],
            ...
            ['FOOBAR', 'foo',    'i;ascii-casemap', 'contains', true],
            ['FÃ–Ã–BAR', 'FÃ–Ã–',    'i;ascii-casemap', 'contains', true],
            ['FÃ–Ã–BAR', 'fÃ¶Ã¶',    'i;ascii-casemap', 'contains', false],
            ...
            ['FOOBAR', 'foo',    'i;unicode-casemap', 'contains', true],
            ['FÃ–Ã–BAR', 'FÃ–Ã–',    'i;unicode-casemap', 'contains', true],
            ['FÃ–Ã–BAR', 'fÃ¶Ã¶',    'i;unicode-casemap', 'contains', true],
