...
) ENGINE=InnoDB AUTO_INCREMENT=40327 DEFAULT CHARSET=utf8 COMMENT='Absenzen der Schüler';
...
CREATE TABLE IF NOT EXISTS `absenzen_absenzen_stunden` (
                                                           ...
                                                           PRIMARY KEY (`absenzID`,`absenzStunde`) USING BTREE
...
) ENGINE=InnoDB AUTO_INCREMENT=13637 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=3094476 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `database_database` (
                                                   ...
                                                   PRIMARY KEY (`databaseID`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `database_user2database` (
                                                        ...
                                                        PRIMARY KEY (`userID`,`databaseID`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `kalender_extern` (
                                                 ...
                                                 PRIMARY KEY (`eintragID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=27350040 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=2483 DEFAULT CHARSET=utf8 COMMENT='Alle Ferien in den nächsten Jahren';
...
CREATE TABLE IF NOT EXISTS `kalender_lnw` (
                                              ...
                                              PRIMARY KEY (`eintragID`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=9926 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `klassenkalender` (
                                                 ...
                                                 `eintragStunden` varchar(255) NOT NULL,
                                                 PRIMARY KEY (`eintragID`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=5540 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=1093 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `schulbuch_ausleihe` (
                                                    ...
                                                    PRIMARY KEY (`ausleiheID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=29924 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=19549 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=483008 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `user_images` (
                                             ...
                                             PRIMARY KEY (`userImageID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `users` (
                                       ...
                                       PRIMARY KEY (`userID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9064 DEFAULT CHARSET=utf8 COMMENT='Enthält alle Benutzer, die SchuleIntern benutzen können';
...
CREATE TABLE IF NOT EXISTS `wlan_schueler` (
                                               ...
                                               PRIMARY KEY (`schuelerID`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
